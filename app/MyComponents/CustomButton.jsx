...
export default function CustomButton({innerText}) {
    return (
        <button className="relative overflow-hidden rounded-full border-2 border-cyan-300 text-cyan-300 font-bold py-2 px-4 m-1 group cursor-pointer">
